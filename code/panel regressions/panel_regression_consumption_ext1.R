...
# load data
cons_ext1_raw <- read.csv("../data/data_cy_ext_1.csv")

# load home bias data
ehb_data <- read.csv("../data/ehb_long_orig_small.csv")
...
cons_ext1_aggregate2 <- cons_ext1 %>%
...
# merge data
merged_df <- list(cons_ext1, ehb_data) %>%
...
stargazer(
  reg_cons_stage2,
  type = "latex",
  out = file.path(output_dir, "table3_2019_reg_consumption_risk_sharing.tex"),
  title = "OECD REP 1993 - 2019 Consumption Risk Sharing and Equity Home Bias",
...
file.exists(file.path(output_dir, "table3_2019_reg_consumption_risk_sharing.tex"))
...
stargazer(
  table5_cons_models,
  type = "latex",
  out = file.path(output_dir, "table5_2019_consumption_foreign_assets.tex"),
  title = "OECD REP 1993 - 2019 Consumption Risk Sharing and Foreign Asset Holdings Relative to GDP",
  dep.var.labels = "Consumption Risk Sharing",
  column.labels = c(
    "Equity",
    "Debt",
...
file.exists(
  file.path(output_dir, "table5_2019_consumption_foreign_assets.tex")
)
