...
# load data
reg_gni_df <- read.csv("../data/reg_gni_df_ext_4b.csv")
...
stargazer(
  reg_gni_stage2,
  type = "latex",
  out = file.path(output_dir, "3panel_reg_gni_ext_4b.tex"),
  title = "Ext 4b GNI Risk Sharing and Equity Home Bias",
...
file.exists(file.path(output_dir, "3panel_reg_gni_ext_4b.tex"))
...
stargazer(
  table5_gni_models,
  type = "latex",
  out = file.path(output_dir, "5panel_reg_gni_ext_4b.tex"),
  title = "Ext 4b GNI Risk Sharing and Foreign Asset Holdings Relative to GDP",
  dep.var.labels = "GNI Risk Sharing",
  column.labels = c(
    "Equity",
    "Debt",
...
file.exists(
  file.path(output_dir, "5panel_reg_gni_ext_4b.tex")
)