...
# load data
reg_gni_df <- read.csv("../data/reg_gni_df_ext_2.csv")
...
stargazer(
  reg_gni_stage2,
  type = "latex",
  out = file.path(output_dir, "3_panel_reg_gni_ext_2.tex"),
...
file.exists(file.path(output_dir, "3_panel_reg_gni_ext_2.tex"))
...
stargazer(
  table5_gni_models,
  type = "latex",
  out = file.path(output_dir, "5_panel_reg_gni_ext_2.tex"),
...
file.exists(
  file.path(output_dir, "5_panel_reg_gni_ext_2.tex")
)
