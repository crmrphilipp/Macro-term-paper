# ============================================
# Extention 5a: Sample with Eurozone as its own observation 1993 - 2019
#=============================================
...
# load data
gni_rep_raw <- read.csv("../data/data_iy_ext_5a.csv")
...
### Regression sample
reg_sample_common <- c(
  "AUS", "BGR", "BRA", "CAN", "CHE", "CHL",
  "CHN", "COL", "CZE", "DNK", "EA20", "GBR", "HKG",
  "HUN", "IDN", "IND", "ISR", "JPN", "KOR",
  "MEX", "NOR", "POL", "ROU", "RUS", "SAU",
  "SGP", "SWE", "TUR", "USA", "ZAF"
)
