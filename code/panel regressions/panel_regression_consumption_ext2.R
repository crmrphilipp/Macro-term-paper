...
# Note: Data is only available for 27 oecd countries
#=============================================
...
# load data
cons_ext2_raw <- read.csv("../data/data_cy_ext_2.csv")
...
stargazer(
  reg_cons_stage2,
  type = "latex",
  out = file.path(output_dir, "ext2_table3_2019_reg_consumption_risk_sharing.tex"),
  title = "OECD ext2 1993 - 2019 Consumption Risk Sharing and Equity Home Bias",
...
file.exists(file.path(output_dir, "ext2_table3_2019_reg_consumption_risk_sharing.tex"))
...
stargazer(
  table5_cons_models,
  type = "latex",
  out = file.path(output_dir, "ext2_table5_2019_consumption_foreign_assets.tex"),
  title = "EXT2 OECD REP 1993 - 2019 Consumption Risk Sharing and Foreign Asset Holdings Relative to GDP",
  dep.var.labels = "Consumption Risk Sharing",
  column.labels = c(
    "Equity",
    "Debt",
...
file.exists(
  file.path(output_dir, "ext2_table5_2019_consumption_foreign_assets.tex")
)
