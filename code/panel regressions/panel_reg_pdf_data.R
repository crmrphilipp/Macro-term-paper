...
stargazer(
  ...
  type = "latex",
  out = file.path(output_dir, "3pdf_cons_se.tex"),
  
  title = "PDF Consumption Risk Sharing and Equity Home Bias",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_dir, "3pdf_gni_se.tex"),
  
  title = "PDF GNI Risk Sharing and Equity Home Bias",
...
write_table5_latex(
  ...
  out_file = "5pdf_cons_point_estimates.tex"
)
...
write_table5_latex(
  ...
  caption = "PDF GNI Risk Sharing and Foreign Assets over GDP",
  label = "tab:table5_gni_assets",
  out_file = "5pdf_gni_point_estimates.tex"
)
...
file.exists(file.path(output_dir, "5pdf_cons_point_estimates.tex"))
file.exists(file.path(output_dir, "5pdf_gni_point_estimates.tex"))

file.exists(file.path(output_dir, "3pdf_cons_se.tex"))
file.exists(file.path(output_dir, "3pdf_gni_se.tex"))
