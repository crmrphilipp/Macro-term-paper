...
stargazer(
  table5_cons_models,
  type = "latex",
  out = file.path(output_dir, "5panel_reg_cons_ext_3.tex"),
  title = "Ext-3 REP Consumption Risk Sharing and Foreign Asset Holdings Relative to GDP",
  dep.var.labels = "Consumption Risk Sharing",
  column.labels = c(
    "Equity",
    "Debt",
...
file.exists(
  file.path(output_dir, "5panel_reg_cons_ext_3.tex")
)
