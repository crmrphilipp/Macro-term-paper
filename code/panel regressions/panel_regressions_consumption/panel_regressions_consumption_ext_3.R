...
stargazer(
  reg_cons_stage2,
  type = "latex",
  out = file.path(output_dir, "3_panel_reg_cons_ext_3.tex"),
  title = "Euroarea Sample 1987-2017  Consumption Risk Sharing and Equity Home Bias",
...
stargazer(
  table5_cons_models,
  type = "latex",
  out = file.path(output_dir, "5_panel_reg_cons_ext_3.tex"),
  title = "Euroarea Sample 1987-2017 Consumption Risk Sharing and Foreign Asset Holdings Relative to GDP",
  dep.var.labels = "Consumption Risk Sharing",
  column.labels = c(
    "Equity",
    "Debt",
...
file.exists(
  file.path(output_dir, "5_panel_reg_cons_ext_3.tex")
)
