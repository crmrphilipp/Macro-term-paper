...
# load data
reg_cons_df <- read.csv("../data/reg_cons_df_ext_5b.csv")
...
stargazer(
  reg_cons_stage2,
  type = "latex",
  out = file.path(output_dir, "3panel_reg_cons_ext_5b.tex"),
  title = "Ext-5b Consumption Risk Sharing and Equity Home Bias",
...
file.exists(file.path(output_dir, "3panel_reg_cons_ext_5b.tex"))
...
stargazer(
  table5_cons_models,
  type = "latex",
  out = file.path(output_dir, "5panel_reg_cons_ext_5b.tex"),
  title = "Ext-5b REP Consumption Risk Sharing and Foreign Asset Holdings Relative to GDP",
  dep.var.labels = "Consumption Risk Sharing",
  column.labels = c(
    "Equity",
    "Debt",
...
file.exists(
  file.path(output_dir, "5panel_reg_cons_ext_5b.tex")
)
