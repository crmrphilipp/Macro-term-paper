...
% ============================================================
Sørensen et al. argue in their 2007 paper \textit{Home Bias and International Risk Sharing: Twin Puzzles Separated at Birth}
that the macroeconomic concept of international risk sharing and the financial economic finding that investors tend to hold
a disproportionately large share of domestic assets -- the so-called home bias -- are closely related and may be manifestations
of the same underlying behavior.

We use \textcite{main} as a starting point to investigate this relationship further, replicate their main findings, and extend
their analysis by a time period of 20 years, as well as by a larger country sample of XX OECD countries.\footnote{Country 
sample extensions were constrained by data availability.}\

We then depart from the original paper by shifting our focus to the euro area as an interesting case study for investigating
the relationship between home bias and international risk sharing. European integration, both during the original paper's sample
period (1993--2003) and during our extended time period (1987--2017), provides an opportunity to analyze whether a decline in 
exchange rate risk and transaction costs is directly associated with a declining home bias and an increase in international risk 
sharing. Puzzling results from a naive analysis, which suggest that euro area countries became more diversified with countries 
\textit{outside} the euro area during the process of integration, lead us to an extensive discussion of financial centers in the 
euro area. We identify a potential shortcoming of the original paper that may have become increasingly relevant over the past two 
decades due to the rise of financial centers within the euro area. The contribution of this extension should therefore be understood
as a friendly warning to future research extending \textcite{main}, suggesting that this shortcoming may distort an uncorrected 
analysis. \

Second, we use the euro area case study to focus on the channels of risk sharing. 
Combining \textcite{main} with \textcite{asy1996}, we note that risk sharing \textit{within} the euro area has increased after 1999
and analyze whether this increase can be attributed specifically to a reduction in home bias. Using a variance decomposition method,
we find that home bias and risk sharing are negatively associated in the euro area, confirming the findings of \textcite{main} 
at a more granular level and with a different methodology.
