...
1. Discussion of Methodology
    ...
    fit the trend better leading to higher weights. Additionally, countries with stable growth in the short period might just have a better fit but 
    ...
    Am I right in understanding that the paper uses a two stage feasable GLS approach, weighted by the inverse of the standard deviation of the residuals? Please scan the original
    paper for further hints on how exactly they run this two stage regression.
...
2. Writing or Correcting Code
    ...
    to assistants like copilot in vs-code or for finding problems in the code. Further, we used AI to clean and comment self-generated code, to make it easier to understand 
    for other group members. We used AI in some instances to translate STATA code to R code, as one group member used STATA and not R in his undergrad.
    ...
    Example:
        I just wrote this code. Please make sure it runs smoothly and comment the main parts of it to make sure that other group members are able to understand it, even if 
        they have not been involved in writing this code. \
    Example: 
        Please explain how this STATA command works in R [Insert relevant STATA command]. Please let me know any structural differences in how this command is used in R compared to STATA
